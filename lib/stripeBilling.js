...
async function syncEntitlementsForEmail(stripe, email) {
  ...
  return {
    ...
    hint: `Use the same email at checkout as your WriteFlow login. Stripe mode on server: ${mode}. If you paid before adding metadata, try again after deploy — or contact support with your Stripe receipt email.`,
  };
}
